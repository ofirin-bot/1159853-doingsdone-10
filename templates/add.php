...
<main class="content__main">
        ...
        <form class="form"  action="add.php" method="post" enctype="multipart/form-data" autocomplete="off">
          ...
          <div class="form__row">             
            ...
            <input class="form__input form__input--date <?= $classname; ?>" type="text" name="dt_complet" id="date" value="<?= getPostVal('dt_complet'); ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
          ...
          <div class="form__row">
            ...
            <div class="form__input-file">
              <input class="visually-hidden <?= $classname; ?>" type="file" name="file" id="file" value="<?= getPostVal('file'); ?>">
